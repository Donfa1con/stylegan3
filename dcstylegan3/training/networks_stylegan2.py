...
from dcstylegan3.torch_utils import misc
from dcstylegan3.torch_utils import persistence
from dcstylegan3.torch_utils.ops import bias_act
from dcstylegan3.torch_utils.ops import conv2d_resample
from dcstylegan3.torch_utils.ops import fma
from dcstylegan3.torch_utils.ops import upfirdn2d
...
def modulated_conv2d(
    ...
    if x.dtype == torch.float16 and demodulate:
        weight = weight * (
                1 / np.sqrt(in_channels * kh * kw) / weight.norm(float('inf'), dim=[1, 2, 3], keepdim=True))  # max_Ikk
